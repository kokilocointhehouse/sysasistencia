{!! Form::open(array('url'=>'reporte/grafico', 'method'=>'GET', 'autocomplete'=>'off', 'role'=>'search')) !!}
...
<div class="card-header">
    ...
    <div class="card-tools">
        <div class="input-group input-group-sm" >
            ...
            @endif
            <a href="{{route('reporte_grafico_personal.pdf',[$searchText, $searchText2])}}" target="_blank" title="Reporte en PDF"
